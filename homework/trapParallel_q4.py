#trapParallel_q4.py
#Implement the Load-balancing fix to the code trapParallel_1.py The program should
#be able to take in any number of trapezoids n for any number of processes and the trapezoids
...
if (n%size==0) and (rank!=size-1):
	...
	local_n=math.floor(n/size)+(n%size)
...
if rank == 0:
	...
	# all other processes send their results
...
if comm.rank == 0:
	...
	,a, "to",b, "is", total, "and took", t_end-t_start, "seconds.")
